...
class HwUnitErrorEventListLiveData(private val databaseReference: DatabaseReference?) :
        LiveData<List<HwUnitLog<Any>>>() {
    ...
    private val hwUnitsListener: ValueEventListener by lazy {
        object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                Timber.d(
                        "onDataChange (key=$key)(hwUnitErrorEventList=${hwUnitErrorEventList.size})")
