...
@PrepareForTest({ViewConfiguration.class, HomeUnitGpio.class, Gpio.class, Log.class})
public class HomeUnitGpioTest {
    ...
    public void close() throws IOException {
        HomeUnitGpio gpio = new SensorGpio(mGpio, Gpio.ACTIVE_LOW);
        gpio.close();
